...
def main():
    ...
    parser.add_argument('--save_path', type=str, default='/public/home/jiawang/caijiaming/SegRegBase4MediaLab-main/results/base',help="all log save path")
    parser.add_argument('--train_path', type=str, default='/public/home/jiawang/Data/dataset_330_80/train/unlabeled/images/*',help="train dataset path")
    parser.add_argument('--test_path', type=str, default='/public/home/jiawang/Data/dataset_330_80/test/vol/*',help="test dataset path")
    parser.add_argument('--src_path', type=str, default='/public/home/jiawang/Data/dataset_330_80/atlas/vol/atlas_vol.nii',help="atlas image path")
    parser.add_argument('--sseg_path', type=str, default='/public/home/jiawang/Data/dataset_330_80/atlas/seg/atlas_seg.nii',help="atlas label path")
